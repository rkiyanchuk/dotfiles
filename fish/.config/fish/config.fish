...
set --export --global GOPATH ~/.go
fish_add_path --global ~/.go/bin               # Golang executables
...
if test (uname) = "Darwin"
    ...
    fish_add_path --global "/Applications/IntelliJ IDEA.app/Contents/MacOS" # Add IntelliJ IDEA
...
if status is-interactive
  function update --description 'update all CLI tools'
    switch (uname)
      case "Darwin"
        brew update; brew upgrade --greedy-latest; brew autoremove; brew cleanup
      end
